  ...
  return (
    <div className="flex flex-col items-center justify-center bg-hackathon-teal-800">
      <div className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden">
        <Image
          className="absolute inset-0 z-0 h-full w-full object-cover lg:h-auto"
          ...
          <div className="relative flex w-full flex-col items-center justify-center lg:w-auto min-[1400px]:mt-60">
            <div className="relative w-fit max-[600px]:w-[500px] max-[460px]:w-[450px]">
              ...
              <div className="absolute inset-0 mt-8 flex flex-col items-center justify-start px-6 pt-6 max-[640px]:mt-0 lg:mt-8">
                ...
                <button className="mt-[20%] w-fit rounded-[20px] border-[3px] border-solid border-black bg-hackathon-off-white-100 px-6 py-[10px] font-inknut text-xl shadow-[-3px_3px_2px_0px_#47B7A0] max-[615px]:text-base max-[455px]:mt-12">
                  Register
                </button>
              </div>
            </div>
