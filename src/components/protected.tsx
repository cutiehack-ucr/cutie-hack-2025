...
const ProtectedPage = async ({ children, restrictions, session }: props) => {
  ...
  return (
    <>
      ...
      <div className="relative z-0 flex h-screen w-full items-start overflow-x-hidden bg-gradient-to-b from-hackathon-teal-800 to-hackathon-teal-100 px-4 sm:from-hackathon-teal-100 sm:to-hackathon-teal-800">
